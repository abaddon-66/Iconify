...
class QSFluidThemeA15(context: Context) : ModPack(context) {
        ...
        qsTileViewImplClass
            ...
            .runAfter { param ->
                ...
                try {
                    ...
                    setObjectField(param.thisObject, "colorActive", colorActiveAlpha)
                    setObjectField(
                        param.thisObject,
                        "colorInactive",
                        changeAlpha(
                    ...
                    setObjectField(param.thisObject, "colorLabelActive", colorActive)
                    setObjectField(param.thisObject, "colorSecondaryLabelActive", colorActive)
                } catch (throwable: Throwable) {
                    log(TAG + throwable)
                }
    ...
    companion object {
        private val TAG = "Iconify - ${QSFluidThemeA15::class.java.simpleName}: "
